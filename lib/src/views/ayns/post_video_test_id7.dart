...
class PostVideoTestPageId7 extends StatelessWidget {
  const PostVideoTestPageId7({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage(
                                      "assets/videos/image_7.png"), // Hình thumbnail id:7
                                  fit: BoxFit.cover),
                            ),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: const Column(
                                ...
                                children: [
                                  SizedBox(
                                    width: double.infinity,
                                    child: Text(
                                      "THƯƠNG NGOẠI 85 TUỔI, MẮT MỜ CHÂN CHẬM VẪN LẶN LỘI BÁN TỪNG BÓ RAU ĐỂ MƯU SINH GIỮA SÀI GÒN HOA LỆ 🥺❤️", // Caption Uppercase id:7
                                      style: TextStyle(
                              ...
                              child: Row(children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(30),
                                    child: Image.asset(
                                      "assets/videos/image_7_7.jpeg", // Avatar id:7
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                          ...
                          Container(
                            ...
                            child: const Text(
                              "Tiền mặt: 4,000,000 VND", // Current Amount id:7
                              style: TextStyle(
                          ...
                          Container(
                            margin: const EdgeInsets.only(bottom: 10, left: 66),
                            child: const Text(
                              "Ngày đăng: 25/11/2025", // CreatedAt id:7 (approx 1 day ago)
                              style: TextStyle(
                                color: Color(0xFF675F5F),
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Ngoại tâm sự con cái đều đi làm ăn xa, ngoại không muốn làm gánh nặng nên ngày nào cũng đi bán từ sáng sớm đến tối mịt. Hôm nay tụi con bao hết xấp vé số cho ngoại về sớm nghỉ ngơi. Mong ngoại luôn khỏe mạnh.", // Description id:7
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: "Quận 1, TP.HCM", // Address id:7
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                          ...
                          // Witness Section (Dummy Data for ID 7)
                          Container(
                            margin: const EdgeInsets.only(bottom: 17, left: 14),
                            child: RichText(
                              ...
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: "Chức vụ: Tổ trưởng tổ dân phố\n",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                                  ...
                                  TextSpan(
                                    text: "Số điện thoại Zalo : 0988111222\n",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
