...
class _mainTestKKState extends State<mainTestKK> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      const SizedBox(), // Index 2: Placeholder (Để trống vì Reels dùng push)
  ...
  // --- GIAO DIỆN TRANG CHỦ CŨ (Được tách ra để giữ nguyên 100%) ---
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SafeArea(
          // Sử dụng IndexedStack để giữ trạng thái các tab
          child: IndexedStack(
            index: _currentIndex,
            children: _pages,
          ),
        ...
        bottomNavigationBar: MyNavigationBar(
          ...
          onTap: _onTabTapped, // Sử dụng hàm đã xử lý logic push/switch
        ));
  }
}
