...
class PostVideoTestPageId3 extends StatelessWidget {
  const PostVideoTestPageId3({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage(
                                      "assets/videos/image_3.png"), // Hình thumbnail id:3
                                  fit: BoxFit.cover),
                            ),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: const Column(
                                ...
                                children: [
                                  SizedBox(
                                    width: double.infinity,
                                    child: Text(
                                      "70 TUỔI VẪN CẶM CỤI NHẶT TỪNG VỎ LON GIỮA TRỜI ĐÔNG GIÁ RÉT ĐỂ MƯU SINH", // Caption Uppercase id:3
                                      style: TextStyle(
                              ...
                              child: Row(children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(30),
                                    child: Image.asset(
                                      "assets/videos/image_3_3.jpeg", // Avatar id:3
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                          ...
                          Container(
                            ...
                            child: const Text(
                              "Tiền mặt: 4,200,000 VND", // Current Amount id:3
                              style: TextStyle(
                          ...
                          Container(
                            margin: const EdgeInsets.only(bottom: 10, left: 66),
                            child: const Text(
                              "Ngày đăng: 26/11/2025", // CreatedAt id:3 (approx)
                              style: TextStyle(
                                color: Color(0xFF675F5F),
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Cụ Thơm không con cái, sống tạm bợ trong túp lều dựng tạm. Hàng ngày cụ đi nhặt ve chai từ sáng sớm, thu nhập chỉ vài chục nghìn đủ mua rau cháo. Mùa đông về, cụ vẫn chưa có lấy một chiếc chăn ấm.", // Description id:3
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Gầm cầu Long Biên, Hà Nội", // Address id:3
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                          ...
                          // Witness Section (Dummy Data for ID 3)
                          Container(
                            margin: const EdgeInsets.only(bottom: 17, left: 14),
                            child: RichText(
                              ...
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Chức vụ: Tình nguyện viên CLB Thiện Nguyện Hà Nội\n",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                                  ...
                                  TextSpan(
                                    text: "Số điện thoại Zalo : 0933666777\n",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
