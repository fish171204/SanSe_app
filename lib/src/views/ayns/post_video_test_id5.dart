...
class PostVideoTestPageId5 extends StatelessWidget {
  const PostVideoTestPageId5({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage(
                                      "assets/videos/image_5.png"), // Hình thumbnail id:5
                                  fit: BoxFit.cover),
                            ),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: const Column(
                                ...
                                children: [
                                  SizedBox(
                                    width: double.infinity,
                                    child: Text(
                                      "BÀ CỤ LỚN TUỔI ĐI LỤM VE CHAI SỐNG QUA NGÀY XIN ANH CHỊ GIÚP ĐỠ", // Caption Uppercase
                                      style: TextStyle(
                                        color: Color(
                              ...
                              child: Row(children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.asset(
                                      "assets/videos/image_5_5.jpeg", // Avatar id:5
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                ),
                          ...
                          Container(
                            ...
                            child: const Text(
                              "Tiền mặt: 30,000,000 VND", // Current Amount id:5
                              style: TextStyle(
                          ...
                          Container(
                            margin: const EdgeInsets.only(bottom: 10, left: 66),
                            child: const Text(
                              "Ngày đăng: 20/11/2025", // CreatedAt id:5 (approx)
                              style: TextStyle(
                                color: Color(0xFF675F5F),
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Nhìn dáng bà cụ lưng còng, tay run rẩy nhặt từng vỏ chai nhựa mà xót xa. Ở cái tuổi lẽ ra được an hưởng tuổi già thì bà vẫn phải lang thang mưu sinh từng bữa. Bà không có con cái nương tựa, sống trong căn trọ nhỏ chật hẹp. Mong mọi người chung tay giúp đỡ để bà có bữa cơm no và trang trải chi phí sinh hoạt hằng ngày.", // Description id:5
                                    style: TextStyle(
                                      color: Colors
                            ...
                            child: RichText(
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Quận Bình Tân, TP.HCM", // Address id:5
                                    style: TextStyle(
                                      color:
                            ...
                            child: RichText(
                              ...
                              text: const TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        "Chức vụ: CSKV Phường Bình Hưng Hòa A, Q.Bình Tân\n",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                                  ...
                                  TextSpan(
                                    text: "Số điện thoại Zalo : 0909123456\n",
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 16,
                                    ),
                                      ...
                                      onTap: () {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              content: Image.asset(
                                                "assets/videos/image_5.png", // Using thumbnail as evidence
                                                fit: BoxFit.cover,
                                              ),
                                            );
                                          },
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(30),
                                          child: Image.asset(
                                            "assets/videos/image_5.png", // Evidence image
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
                                      ...
                                      onTap: () {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              content: Image.asset(
                                                "assets/videos/image_5_5.jpeg", // Using avatar as evidence 2
                                                fit: BoxFit.cover,
                                              ),
                                            );
                                          },
                                      ...
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(30),
                                          child: Image.asset(
                                            "assets/videos/image_5_5.jpeg", // Evidence image 2
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      ),
